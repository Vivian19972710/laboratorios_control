...
class Node():
    ...
    def initParameters(self):
        ...
        self.topic_ang = "/angular_3"
        self.topic_lin = "/linear_3"
	...
	self.sub_eme = self.rospy.Subscriber(self.topic_emergency, String, self.callback_emergency)
        return
